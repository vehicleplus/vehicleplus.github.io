...
<h1>목차</h1>
 <ul>
	<ol type="1" start="1">
 		<li><a href="#title_1">어썸커넥트 앱 설치하기</a></li>
...
<h3><div id="title_1">1. 어썸커넥트 앱 설치하기</div></h3>
어썸커넥트 SDK는 첫번째로 Google Play에서 어썸커넥트앱을 설치해야 사용이 가능합니다.

Google Play를 통해 제공되는 어썸커넥트는 일반 사용자에게 공개된 어플리케이션으로 차량과의 통신을 위해 필수적으로 설치되어야합니다.<br> 개발자는 이곳에서 제공되는 어썸커넥트앱을 이용하여, SDK로 접근할 수 있습니다.
<br>
<br>
어썸커넥트 앱 구글플레이 주소 : <br>
...
<br>
<br>
어썸커넥트 앱의 설치방법은 Google Play에서 일반적인 앱을 설치하는 방법과 동일합니다. 위의 URL에서 설치를 선택해서 진행하면 간단하게 완료할 수 있습니다. 
<br>
<br>
> NOTE: <br>
어썸커넥트 앱은 안드로이드 5.0 이상, 인터넷이 연결되어 있는 모바일에서만 지원합니다. <br>
오프라인 환경에서만 사용가능한 프라이빗 버전은 관리자에게 별도로 문의해주시길 바랍니다.
<br>
<br>
<h3><div id="title_2">2. SDK 설치하기</div></h3>
어썸커넥트 앱을 설치하였으면, 어썸커넥트앱과 통신하기 위해 SDK를 설치해야합니다. 안드로이드 컴포넌트가 포함된 라이브러리로 구성되어 있습니다. SDK는 aar파일의 형태로 손쉽게 다운로드 받을 수 있습니다.

비이클 플러스 SDK 다운로드 주소 : <br>
[https://github.com/vehicleplus/library](https://github.com/vehicleplus/library)
...
일반적인 aar 라이브러리의 추가 방법과 동일합니다. 이 문서에서는 초기 버전인 0.0.1 버전기준으로 설명하고, 안드로이드 스튜디오 3.3.2 버전 기준으로 설명합니다.

Github에서 vehicleplus-sdk-android-0.0.1.aar를 다운로드 받습니다. <br>
...
어썸커넥트 SDK를 사용하기 위해서는 지정된 오픈소스를 추가해야합니다.
